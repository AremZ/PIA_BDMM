    ...
    <div class="container-fluid padding">
        <div class="row">
            ...
            <div class="col-lg-2">
                ...
                onclick="cleanInput('fnameEditor'), cleanInput('snameEditor'), cleanInput('lnameEditor'), cleanInput('emailREditor'),
                cleanInput('telEditor'), cleanInput('pwdEditor'), cleanInput('rpwdEditor'), createReportero()"><i class="fa fa-plus-circle"></i>Crear reportero</button>
            </div>
        </div>
    </div>
    <hr class="topAdmin">
    ...
    <div id="modRegister" class="modal fade">
        <div class="modal-dialog" id="registroUsuarios">
            ...
            <div class="modal-content">
                ...
                <div id="registerEditor" class="modal-body">
                    <div>
                        <h1 id="titleEditor">Crear un reportero</h1>
                        <hr>
                    </div>
                   <form>
                       <div class="row">
                           ...
                           <div class="col-md-10">
                               <div class="row">
                                   <div class="col-md-4 form-group">
                                       <label for="fname">Nombre(s):</label>
                                       <div id="nameContainerEditor">
                                         <input type="text" class="form-control" id="fnameEditor" onfocus="cleanInputClass('fnameEditor')">
                                       </div>
                                   </div>
                                   <div class="col-md-4 form-group">
                                       <label for="sname">Apellido Paterno:</label>
                                       <div id="snameContainerEditor">
                                         <input type="text" class="form-control" id="snameEditor" onfocus="cleanInputClass('snameEditor')">
                                       </div>
                                   </div>
                                   <div class="col-md-4 form-group">
                                       <label for="lname">Apellido Materno:</label>
                                       <div id="lnameContainerEditor">
                                         <input type="text" class="form-control" id="lnameEditor" onfocus="cleanInputClass('lnameEditor')">
                                       </div>
                                   </div>
      
                                   <div class="col-md-6 form-group">
                                       <label for="email">Correo Electronico:</label>
                                       <div id="mailRContainerEditor">
                                         <input type="email" class="form-control" id="emailREditor" onfocus="cleanInputClass('emailREditor')">
                                       </div>
                                   </div>
                                   <div class="col-md-6 form-group">
                                       <label for="rpwd">Telefono:</label>
                                       <div id="telContainerEditor">
                                         <input type="number" class="form-control" id="telEditor" onfocus="cleanInputClass('telEditor')">
                                       </div>
                                   </div>  
      
                                   <div class="col-md-6 form-group">
                                       <label for="pwd">Contraseña:</label>
                                       <div id="passRContainerEditor">
                                         <input type="password" class="form-control" id="pwdEditor" onfocus="cleanInputClass('pwdEditor')">
                                       </div>
                                   </div>
                                   <div class="col-md-6 form-group">
                                       <label for="rpwd">Confirme su contraseña:</label>
                                       <div id="rpassContainerEditor">
                                         <input type="password" class="form-control" id="rpwdEditor" onfocus="cleanInputClass('rpwdEditor')">
                                       </div>
                                   </div>
                   ...
                   <hr>
                   <button type="button" class="btn btn-outline-danger" 
                       style="float:right" onclick="validaciones(4)" id="registerUserEditor"><i class="fa fa-check"></i>Registrar
                   </button>
                   <button type="button" class="btn btn-outline-danger" 
